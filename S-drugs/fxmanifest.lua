...
files = {
    'stream/freeze_S-drugs_table.ytyp',
    'stream/freeze_S-scripts_coke_table.ydr',
    'stream/freeze_S-scripts_meth_table.ytyp',
    'stream/freeze_S-scripts_weed_table.ydr',
    --------------Lemon Haze-------------------
...
data_file 'DLC_ITYP_REQUEST' 'stream/freeze_S-drugs_table.ytyp'
data_file 'DLC_ITYP_REQUEST' 'stream/freeze_S-scripts_coke_table.ydr'
data_file 'DLC_ITYP_REQUEST' 'stream/freeze_S-scripts_meth_table.ytyp'
data_file 'DLC_ITYP_REQUEST' 'stream/freeze_S-scripts_weed_table.ydr'
------------------------Lemon haze-------------------------------
