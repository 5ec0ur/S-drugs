...
RegisterNetEvent('S-drugs:client:takeDrug', function(drugItem)
...
lib.callback.register('S-drugs:client:isDrugOnCooldown', function(drugItem)
...
lib.callback.register('S-drugs:client:getCurrentDrugEffect', function()
    return currentDrug
end)