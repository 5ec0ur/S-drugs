...
--[[
    ...
    https://help.S-scripts.com/scripts/S-drugs/installation
]]
...
--[[
    ...
    If you need need more information about this configuration, you can read the documentation here: https://help.S-scripts.com/scripts/S-drugs
]]
...
Config.ProcessingTables = { -- Create processing table
    ['weed_processing_table'] = {
        ...
        model = 'freeze_S-scripts_weed_table', -- Exanples: freeze_S-scripts_empty_table, freeze_S-scripts_weed_table, freeze_S-scripts_coke_table, freeze_S-scripts_meth_table
        recipes = {
            ['joint Lemon haze'] = {
    ...
    ['cocaine_processing_table'] = {
        ...
        model = 'freeze_S-scripts_coke_table', -- Exanples: freeze_S-scripts_empty_table, freeze_S-scripts_weed_table, freeze_S-scripts_coke_table, freeze_S-scripts_meth_table
        recipes = {
            ['cocaine'] = {
                label = 'Cocaine',
                ingrediants = {
...
-- Possible Drug Effects: https://help.S-scripts.com/scripts/S-drugs/adjustments/drugs#all-possible-drug-effects
...
Config.SellSettings = {
    ...
    ['stealChance'] = 10, -- Chance that the ped dont give you money (in %)
