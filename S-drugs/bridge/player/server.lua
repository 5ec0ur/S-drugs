...
function it.getMoney(source, moneyType)
    ...
    lib.print.error('['..it.name..' | getMoney] More information about this error: https://help.S-scripts.com/errors')
    return 0
end
...
-- OX Callbacks
lib.callback.register('S-lib:getPlayerName', function(source)
    return it.getPlayerName(source)
end)

lib.callback.register('S-lib:getCitizenId', function(source)
    return it.getCitizenId(source)
end)

lib.callback.register('S-lib:getLicences', function(source)
    return it.getLicences(source)
end)

lib.callback.register('S-lib:getLicence', function(source, licenseType)
