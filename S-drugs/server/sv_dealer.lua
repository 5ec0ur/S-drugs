...
lib.callback.register('S-drugs:server:getDealers', function()
    local temp = {}
...
lib.callback.register('S-drugs:server:getDealerPosition', function(_, dealerID)
...
lib.callback.register('S-drugs:server:getDealerSellItems', function(_, dealerID)
    if not dealers[dealerID] then
        return
    end
...
lib.callback.register('S-drugs:server:getDealerBuyItems', function(_, dealerID)
    if not dealers[dealerID] then
        return
    end
...
RegisterNetEvent('S-drugs:server:sellItemsToDealer', function (dealerID, item, amount, total)
    ...
    TriggerClientEvent('S-drugs:client:syncRestLoop', source, false)
end)

RegisterNetEvent('S-drugs:server:buyItemsFromDealer', function(dealerID, item, amount, total)
    local src = source
