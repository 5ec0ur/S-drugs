...
lib.callback.register('S-drugs:server:getPlantById', function(source, plantId)
...
---@return Plant | nil: the plant object
lib.callback.register('S-drugs:server:getPlantByNetId', function(source, netId)
...
lib.callback.register('S-drugs:server:getPlantByOwner', function(source)
...
---@param source number: the source player
---@return table | nil: the list of plants
lib.callback.register('S-drugs:server:getPlants', function(source)
...
local setupPlants = function()
    ...
    TriggerClientEvent('S-drugs:client:syncPlantList', -1, plants)
    return true
end
...
AddEventHandler('onResourceStart', function(resource)
    ...
    TriggerClientEvent('S-drugs:client:syncPlantList', -1)
...
RegisterNetEvent('S-drugs:server:createNewPlant', function(coords, plantItem, zone, metadata)
    local src = source
...
RegisterNetEvent('S-drugs:server:plantTakeCare', function(plantId, item)
...
---@param plantId string: the plant Id
RegisterNetEvent('S-drugs:server:harvestPlant', function(plantId)
...
RegisterNetEvent('S-drugs:server:destroyPlant', function(args)
    ...
    if DoesEntityExist(plant.entity) then
        ...
        TriggerClientEvent('S-drugs:client:startPlantFire', -1, plant.coords)
