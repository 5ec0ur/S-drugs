...
lib.callback.register('S-drugs:server:getRecipeById', function(source, tableId, recipeId)
...
lib.callback.register('S-drugs:server:getTableRecipes', function(source, id)
...
lib.callback.register('S-drugs:server:getTableById', function(source, id)
...
lib.callback.register('S-drugs:server:getTableByNetId', function(source, netId)
...
lib.callback.register('S-drugs:server:getTableByOwner', function(source)
...
lib.callback.register('S-drugs:server:getTables', function(source)
    local temp = {}
...
local setupTables = function()
    ...
    TriggerClientEvent('S-drugs:client:syncTables', -1, processingTables)
    return true
end
...
RegisterNetEvent('S-drugs:server:processDrugs', function(data)
...
RegisterNetEvent('S-drugs:server:removeTable', function(args)
...
RegisterNetEvent('S-drugs:server:createNewTable', function(coords, type, rotation, metadata)
    local src = source
...
RegisterNetEvent('S-drugs:server:syncparticlefx', function(status, tableId, netId, particlefx)
    TriggerClientEvent('S-drugs:client:syncparticlefx',-1, status, tableId, netId, particlefx)
end)
